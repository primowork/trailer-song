...
ARTIST_CAP = 2
# 250 ולא 120: החיתוך הקודם השאיר בחוץ להיטי ענק. מדדתי מה יושב בטווח
# שנוסף — דירוגים 121-250 הם Take On Me, We Are The World, Time After
# Time, Shout, Pour Some Sugar On Me, All Star, Livin' La Vida Loca.
# הדילול למילוי מצעד שאיש אינו זוכר מתחיל סביב 300, ולכן העצירה כאן.
PER_DECADE = 250
...
# עשור מלא מקבל PER_DECADE שירים. שנות ה-50 מקבלות פחות כי ה-Hot 100 מתחיל רק
# באוגוסט 1958 — 17 חודשי מצעד בלבד, ומעבר לכ-60 שירים הרשימה נגררת
# לשוליים במקום להישאר בשירים המוכרים.
DECADES = (("50's", 1958, 1959, 60),
           ("60's", 1960, 1969, PER_DECADE),
           ("70's", 1970, 1979, PER_DECADE),
           ("80's", 1980, 1989, PER_DECADE),
           ("90's", 1990, 1999, PER_DECADE),
           ("2000's", 2000, 2009, PER_DECADE),
           ("2010's", 2010, 2020, PER_DECADE))
